#!/usr/bin/python3
# Modifed Version Author: Don Thomas
# Modifed Description: I decided to make my code more OOP therefore I created a class for the motorcontroller 


# These are the information for the people behind the orginal code that I used as backbone 
# File name   : motor.py
