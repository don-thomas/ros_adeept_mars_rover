...
- Obstacle Detection and Identification of Objects using Deep Learning examples yolo or SSD. Might use an edge product if i buy one :) so i could offload my inference. 
